...
Si una extensión es particularmente útil para un determinado país o conjunto de países, puede incluir esa información en la pantalla Detalles del negocio.
